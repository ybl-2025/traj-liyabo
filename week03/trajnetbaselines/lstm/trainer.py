...
def main(epochs=25):
    ...
    hyperparameters.add_argument('--same_cell_aggregation', default='overwrite',
                                 choices=('overwrite', 'mean'),
                                 help='how grid pooling combines neighbours assigned to the same cell')
    ...
    if args.type == 'hiddenstatemlp':
        ...
        pool = GridBasedPooling(type_=args.type, hidden_dim=args.hidden_dim,
                                ...
                                same_cell_aggregation=args.same_cell_aggregation)
